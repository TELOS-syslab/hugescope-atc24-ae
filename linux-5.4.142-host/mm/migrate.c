...
EXPORT_SYMBOL(remove_migration_ptes);
/*
...
//EXPORT_SYMBOL(expected_page_refs);
/*
...
EXPORT_SYMBOL(__unmap_and_move);
/*
...
int do_move_pages_to_node(struct mm_struct *mm,
...
EXPORT_SYMBOL(do_move_pages_to_node);
/*
